            ...
            <ScrollView showsHorizontalScrollIndicator={false}>
                ...
                <View style={styles().formContainer}>
                    ...
                    <View style={styles().btnContainer}>
                        <TouchableOpacity style={{ backgroundColor: dark ? card : secondary, height: scale(50), borderRadius: scale(10), flexDirection: "row", justifyContent: 'center', alignItems: 'center' }}>
