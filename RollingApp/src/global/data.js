...
export const filterData  =  [
    { name: "Cars", image: require('../../assets/ride.png'), id: "0" },
    { name: "Machinery", image: require("../../assets/caterpillar-inc-excavator.png"), id: "1" },
    { name: "Vans", image: require("../../assets/ford-transit-connect.png"), id: "2" },
    { name: "Reserve", image: require("../../assets/reserve.png"), id: "3" }
